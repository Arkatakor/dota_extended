...
function extended_juggernaut_blade_fury:IsNetherWardStealable() return true end
...
function modifier_extended_juggernaut_blade_fury:CheckState()
...
function extended_juggernaut_healing_ward:IsNetherWardStealable() return false end
...
function modifier_extended_juggernaut_blade_dance_empowered_slice:RemoveOnDeath()
	return false
end
...
function modifier_extended_juggernaut_blade_dance_passive:HandleWindDance(bCrit)
	if self.caster:IsRealHero() then
		...
		if self.caster:HasModifier("modifier_extended_juggernaut_blade_dance_empowered_slice") then
			print("ignored!")
			return nil
		end
...
function extended_juggernaut_omni_slash:IsNetherWardStealable() return false end
