...
function modifier_extended_starfall_scepter_thinker:DestroyOnExpire() return false end
function modifier_extended_starfall_scepter_thinker:RemoveOnDeath() return false end
function modifier_extended_starfall_scepter_thinker:IsPermanent() return true end
...
LinkLuaModifier("modifier_extended_leap_aura", "hero/hero_mirana", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_extended_leap_speed_boost", "hero/hero_mirana", LUA_MODIFIER_MOTION_NONE)
...
function modifier_extended_leap_movement:RemoveOnDeath() return false end
function modifier_extended_leap_movement:IgnoreTenacity() return true end
...
LinkLuaModifier("modifier_extended_moonlight_shadow", "hero/hero_mirana", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_extended_moonlight_shadow_invis", "hero/hero_mirana", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_extended_moonlight_shadow_invis_dummy", "hero/hero_mirana", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_extended_moonlight_shadow_invis_fade_time", "hero/hero_mirana", LUA_MODIFIER_MOTION_NONE)
        ...
        for _,ally in pairs(allies) do
            if not ally:HasModifier(self.modifier_invis) then
                ...
                if self:GetDuration() < (duration + self.fade_delay) then
                    ally:AddNewModifier(self.caster, self.ability, "modifier_extended_moonlight_shadow_invis_fade_time", {duration = self.fade_delay})
                end
            end
        end
    end
...
function modifier_extended_moonlight_shadow_invis:OnAbilityExecuted(keys)
    if IsServer() then
        ...
        if self.parent == unit then
            ...
            self.parent:AddNewModifier(self.caster, self.ability, "modifier_extended_moonlight_shadow_invis_fade_time", {duration = self.fade_delay})
        end
    end
end
...
modifier_extended_moonlight_shadow_invis_fade_time = class({})

function modifier_extended_moonlight_shadow_invis_fade_time:IsHidden() return false end
function modifier_extended_moonlight_shadow_invis_fade_time:IsPurgable() return false end
function modifier_extended_moonlight_shadow_invis_fade_time:IsPurgeException() return false end
function modifier_extended_moonlight_shadow_invis_fade_time:IsDebuff() return false end