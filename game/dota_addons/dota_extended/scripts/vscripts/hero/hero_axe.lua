...
MergeTables(LinkedModifiers,{
	["modifier_extended_berserkers_call_buff_armor"] = LUA_MODIFIER_MOTION_NONE,
	["modifier_extended_berserkers_call_debuff_cmd"] = LUA_MODIFIER_MOTION_NONE,
})
-- Hidden Modifiers:
MergeTables(LinkedModifiers,{
	["modifier_extended_berserkers_call_talent"] = LUA_MODIFIER_MOTION_NONE,
})
extended_axe_berserkers_call = extended_axe_berserkers_call or class({})
function extended_axe_berserkers_call:OnSpellStart()
  local caster                    =       self:GetCaster()
  local ability                   =       self

  -- Ability specials
  local radius                    =      ability:GetSpecialValueFor("radius") + caster:FindTalentValue("special_bonus_extended_axe_1")
  ...
  for _,target in pairs(enemies_in_radius) do
    ...
    target:AddNewModifier(caster, self, "modifier_extended_berserkers_call_debuff_cmd", {duration = ability:GetSpecialValueFor("duration")})
  end
  ...
  caster:AddNewModifier(caster, self, "modifier_extended_berserkers_call_buff_armor", {duration = ability:GetSpecialValueFor("duration")})

  if caster:HasTalent("special_bonus_extended_axe_2") then
	local talent_duration = caster:FindTalentValue("special_bonus_extended_axe_2")
    caster:AddNewModifier(caster, self, "modifier_extended_berserkers_call_talent", {duration = ability:GetSpecialValueFor("duration") + talent_duration})
  end

end

function extended_axe_berserkers_call:GetCastAnimation()
  return ACT_DOTA_OVERRIDE_ABILITY_1
end

function extended_axe_berserkers_call:IsHidden()
  return false
end

function extended_axe_berserkers_call:IsHiddenWhenStolen()
  return false
end
...
modifier_extended_berserkers_call_buff_armor = modifier_extended_berserkers_call_buff_armor or class({})
function modifier_extended_berserkers_call_buff_armor:DeclareFunctions()
  local funcs = {
...
function modifier_extended_berserkers_call_buff_armor:GetModifierPhysicalArmorBonus()
  return self:GetAbility():GetSpecialValueFor( "bonus_armor")
end

function modifier_extended_berserkers_call_buff_armor:OnCreated()
...
function modifier_extended_berserkers_call_buff_armor:GetStatusEffectName()
  return "particles/status_fx/status_effect_gods_strength.vpcf"
end

function modifier_extended_berserkers_call_buff_armor:IsPurgable()
  return false
end

function modifier_extended_berserkers_call_buff_armor:IsBuff()
  return true
end

function modifier_extended_berserkers_call_buff_armor:RemoveOnDeath()
  return true
end
...
modifier_extended_berserkers_call_talent = modifier_extended_berserkers_call_talent or class({})

function modifier_extended_berserkers_call_talent:DeclareFunctions()
  local funcs = {
...
function modifier_extended_berserkers_call_talent:GetModifierPhysicalArmorBonus()
	local stack_count = self:GetCaster():GetModifierStackCount("modifier_extended_berserkers_call_talent", self)  
	return stack_count
end

function modifier_extended_berserkers_call_talent:OnAttacked(keys)
  if IsServer() then
    if keys.target == self:GetParent() then
      if self:GetCaster():HasModifier("modifier_extended_berserkers_call_buff_armor") then
        local stack_count = self:GetCaster():GetModifierStackCount("modifier_extended_berserkers_call_talent", self)
        self:GetParent():SetModifierStackCount("modifier_extended_berserkers_call_talent", self, stack_count + 1)
      end
    end
  end
end

function modifier_extended_berserkers_call_talent:IsBuff()
  return true
end

function modifier_extended_berserkers_call_talent:IsHidden()
  return false
end

function modifier_extended_berserkers_call_talent:IsPurgable()
  return false
end
...
modifier_extended_berserkers_call_debuff_cmd = modifier_extended_berserkers_call_debuff_cmd or class({})

function modifier_extended_berserkers_call_debuff_cmd:CheckState()
  local state = {[MODIFIER_STATE_COMMAND_RESTRICTED] = true}
  return state
end

function modifier_extended_berserkers_call_debuff_cmd:OnCreated()
  return true
end

function modifier_extended_berserkers_call_debuff_cmd:DeclareFunctions()
  local funcs = {
...
function modifier_extended_berserkers_call_debuff_cmd:OnDestroy()
  if IsServer() then
...
function modifier_extended_berserkers_call_debuff_cmd:GetModifierAttackSpeedBonus_Constant()
    local caster = self:GetCaster()
    local ability = self:GetAbility()
    self.speed_bonus = ability:GetSpecialValueFor("bonus_as") + caster:FindTalentValue("special_bonus_extended_axe_5")
    return self.speed_bonus
end

function modifier_extended_berserkers_call_debuff_cmd:GetStatusEffectName()
  return "particles/status_fx/status_effect_beserkers_call.vpcf"
end

function modifier_extended_berserkers_call_debuff_cmd:StatusEffectPriority()
  return 10
end

function modifier_extended_berserkers_call_debuff_cmd:IsHidden()
  return false
end

function modifier_extended_berserkers_call_debuff_cmd:IsDebuff()
  return true
end

function modifier_extended_berserkers_call_debuff_cmd:IsPurgable()
  return false
end
...
-- Visible Modifiers:
MergeTables(LinkedModifiers,{
	["modifier_extended_battle_hunger_buff_haste"] = LUA_MODIFIER_MOTION_NONE,
	["modifier_extended_battle_hunger_debuff_dot"] = LUA_MODIFIER_MOTION_NONE,
})

extended_axe_battle_hunger = extended_axe_battle_hunger or class({})
function extended_axe_battle_hunger:OnSpellStart(target)
  ...
  local ability                   =       self
  local caster_modifier           =       "modifier_extended_battle_hunger_buff_haste"
  ...
  if not caster:HasModifier(caster_modifier) then
    ...
    if not target:HasModifier("modifier_extended_battle_hunger_debuff_dot") then
  ...
  --caster:AddNewModifier(caster, self, "modifier_extended_battle_hunger_buff_haste", {})
  target:AddNewModifier(caster, self, "modifier_extended_battle_hunger_debuff_dot", {})
...
modifier_extended_battle_hunger_buff_haste = modifier_extended_battle_hunger_buff_haste or class({})

function modifier_extended_battle_hunger_buff_haste:DeclareFunctions()
  local funcs = {
...
function modifier_extended_battle_hunger_buff_haste:GetModifierMoveSpeedBonus_Percentage()
  return self:GetAbility():GetSpecialValueFor("speed_bonus") * self:GetStackCount()
end

function modifier_extended_battle_hunger_buff_haste:IsHidden()
  return false
end

function modifier_extended_battle_hunger_buff_haste:IsPurgable()
  return false
end
...
modifier_extended_battle_hunger_debuff_dot = modifier_extended_battle_hunger_debuff_dot or class({})

function modifier_extended_battle_hunger_debuff_dot:OnCreated()
  if IsServer() then
...
function modifier_extended_battle_hunger_debuff_dot:OnRefresh()
  self.kill_count = 0
end

function modifier_extended_battle_hunger_debuff_dot:OnIntervalThink()
  if IsServer() then
    local target = self:GetParent()
    local caster = self:GetCaster()
    local damage_over_time = self:GetAbility():GetSpecialValueFor( "damage" ) + caster:FindTalentValue("special_bonus_extended_axe_6")
    local damageTable = {
      victim = target,
      attacker = caster,
...
function modifier_extended_battle_hunger_debuff_dot:DeclareFunctions()
  local funcs = {
...
function modifier_extended_battle_hunger_debuff_dot:GetModifierMoveSpeedBonus_Percentage()
  return self:GetAbility():GetSpecialValueFor("slow") * 0.01
end

function modifier_extended_battle_hunger_debuff_dot:GetModifierTotalDamageOutgoing_Percentage()
...
function modifier_extended_battle_hunger_debuff_dot:GetStatusEffectName()
...
function modifier_extended_battle_hunger_debuff_dot:IsDebuff()
  return true
end

function modifier_extended_battle_hunger_debuff_dot:IsPurgable()
  return true
end

function modifier_extended_battle_hunger_debuff_dot:OnDestroy()
  if IsServer() then
    local caster = self:GetCaster()
    local stack_count = caster:GetModifierStackCount("modifier_extended_battle_hunger_buff_haste", self)
    if (stack_count == 1) then
      caster:RemoveModifierByName("modifier_extended_battle_hunger_buff_haste")
    else
      caster:SetModifierStackCount("modifier_extended_battle_hunger_buff_haste", self, stack_count - 1)
    end
...
function modifier_extended_battle_hunger_debuff_dot:OnDeath(keys)
  if IsServer() then
...
-- Hidden Modifiers:
MergeTables(LinkedModifiers,{
	["modifier_extended_counter_helix_passive"] = LUA_MODIFIER_MOTION_NONE,
})
extended_axe_counter_helix = extended_axe_counter_helix or class({})

function extended_axe_counter_helix:GetIntrinsicModifierName()
  return "modifier_extended_counter_helix_passive"
end
...
modifier_extended_counter_helix_passive = modifier_extended_counter_helix_passive or class({})

function modifier_extended_counter_helix_passive:OnCreated()
  ...
  self.modifier_enemy_taunt = "modifier_extended_berserkers_call_debuff_cmd"

  --ability specials
  self.radius = self.ability:GetSpecialValueFor("radius") + self.caster:FindTalentValue("special_bonus_extended_axe_3")
...
function modifier_extended_counter_helix_passive:OnRefresh()
    self:OnCreated()
end

function modifier_extended_counter_helix_passive:DeclareFunctions()
  local decFuncs = {MODIFIER_EVENT_ON_ATTACKED}
  return decFuncs
end

function modifier_extended_counter_helix_passive:OnAttacked(keys)
  if IsServer() then
    ...
    if keys.target == self:GetParent() then
      ...
      if self.caster:HasTalent("special_bonus_extended_axe_4") then
        self.str = self.caster:GetStrength() / 100
        self.talent_4_value = self.caster:FindTalentValue("special_bonus_extended_axe_4")
...
function modifier_extended_counter_helix_passive:IsPassive()
  return true
end
function modifier_extended_counter_helix_passive:IsHidden()
  return true
end
function modifier_extended_counter_helix_passive:IsBuff()
  return true
end
function modifier_extended_counter_helix_passive:IsPurgable()
  return false
end
...
-- Visible Modifiers:
MergeTables(LinkedModifiers,{
	["modifier_extended_culling_blade_buff_haste"] = LUA_MODIFIER_MOTION_NONE,
})
-- Hidden Modifiers:
MergeTables(LinkedModifiers,{
	["modifier_extended_culling_blade_motion"] = LUA_MODIFIER_MOTION_BOTH,
})
extended_axe_culling_blade = extended_axe_culling_blade or class({})

function extended_axe_culling_blade:GetCastRange()
  return 150 + self:GetCaster():FindTalentValue("special_bonus_extended_axe_8");
end

function extended_axe_culling_blade:OnSpellStart()
  ...
  self.kill_threshold = self.kill_threshold + self.caster:FindTalentValue("special_bonus_extended_axe_7")
  ...
  if self.target:GetHealth() <= self.kill_threshold and not self.target:HasModifier("modifier_extended_reincarnation_scepter_wraith") then

    if self.caster:HasTalent("special_bonus_extended_axe_8") then
      self:GetCaster():AddNewModifier( self:GetCaster(), self, "modifier_extended_culling_blade_motion", kv )
    ...
    for i=0,5 do
      ...
      if self.item and self.item:GetAbilityName():find("^item_extended_blink") then
    ...
    for _,target in pairs(self.allies_in_radius) do
      target:AddNewModifier(self.caster, self, "modifier_extended_culling_blade_buff_haste", {duration = self.speed_duration})
    end
  ...
  if self.scepter then
    ...
    self.battle_hunger_ability = self.caster:FindAbilityByName("extended_axe_battle_hunger")
...
function extended_axe_culling_blade:KillUnit(target)
...
function extended_axe_culling_blade:GetCastAnimation(target)
  if self:GetCaster():HasTalent("special_bonus_extended_axe_8") then
...
modifier_extended_culling_blade_buff_haste = modifier_extended_culling_blade_buff_haste or class({})

function modifier_extended_culling_blade_buff_haste:OnCreated()
...
function modifier_extended_culling_blade_buff_haste:DeclareFunctions()
  local funcs = {
...
function modifier_extended_culling_blade_buff_haste:GetModifierMoveSpeedBonus_Percentage()
  return self:GetAbility():GetSpecialValueFor( "speed_bonus" )
end

function modifier_extended_culling_blade_buff_haste:GetModifierAttackSpeedBonus_Constant()
  return self:GetAbility():GetSpecialValueFor( "as_bonus" )
end

function modifier_extended_culling_blade_buff_haste:IsBuff()
  return true
end

function modifier_extended_culling_blade_buff_haste:IsPurgable()
  return true
end

function modifier_extended_culling_blade_buff_haste:GetStatusEffectName()
...
modifier_extended_culling_blade_motion = modifier_extended_culling_blade_motion or class({})

function modifier_extended_culling_blade_motion:IsHidden() return true end
function modifier_extended_culling_blade_motion:IsPurgable() return false end
function modifier_extended_culling_blade_motion:IsDebuff() return false end
function modifier_extended_culling_blade_motion:RemoveOnDeath() return false end
function modifier_extended_culling_blade_motion:IgnoreTenacity() return true end

function modifier_extended_culling_blade_motion:OnCreated(kv)
...
function modifier_extended_culling_blade_motion:UpdateHorizontalMotion( me, dt )
	if IsServer() then
...
function modifier_extended_culling_blade_motion:UpdateVerticalMotion( me, dt )
	if IsServer() then
