...
function extended_kunkka_ebb_and_flow:IsNetherWardStealable() return false end
function extended_kunkka_ebb_and_flow:IsInnateAbility()
    return true
end
...
function extended_kunkka_x_marks_the_spot:CastFilterResultTarget(target)
    if IsServer() then
        local caster = self:GetCaster()
...
function extended_kunkka_return:IsNetherWardStealable() return false end
