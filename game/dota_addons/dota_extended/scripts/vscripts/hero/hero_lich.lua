...
function extended_lich_cold_front:IsInnateAbility()
    return true
end
...
function modifier_extended_cold_front_debuff:IsPurgable() return true end
...
function modifier_extended_frost_nova_debuff:IsHidden() return false end
function modifier_extended_frost_nova_debuff:IsPurgable() return true end
function modifier_extended_frost_nova_debuff:IsDebuff() return true end
...
function modifier_extended_frost_armor_auto_cast:OnRespawn(keys)
...
function modifier_extended_dark_ritual_creeps:GetModifierAttackSpeedBonus_Constant()     
...
function extended_lich_chain_frost:OnSpellStart()
    ...
    num_bounces = num_bounces + caster:FindTalentValue("special_bonus_extended_lich_7")
