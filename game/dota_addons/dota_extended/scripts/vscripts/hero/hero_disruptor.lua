...
function extended_disruptor_stormbearer:IsInnateAbility()
	return true
end
...
function IncrementStormbearerStacks(caster, stacks)
	...
	local modifier_stormbearer = "modifier_extended_stormbearer"
...
function extended_disruptor_glimpse:GetIntrinsicModifierName()
	return "modifier_extended_glimpse_location_aura"
end

---------------------------------------------------

function extended_disruptor_glimpse:GetCastRange(location, target)
...
function modifier_extended_glimpse_location_aura:AllowIllusionDuplicate()
	return false
end
...
function modifier_extended_glimpse_storm_aura:AllowIllusionDuplicate()
	return false
end
