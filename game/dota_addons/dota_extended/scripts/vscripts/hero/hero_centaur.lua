...
function extended_centaur_thick_hide:IsInnateAbility()
	return true
end
...
function modifier_extended_thick_hide:GetCustomTenacity()
...
function modifier_extended_return_damage_block:OnCreated()
	-- Ability properties
	self.caster = self:GetCaster()
	self.ability = self:GetAbility()
...
function modifier_extended_return_damage_block:GetCustomDamageBlock()
