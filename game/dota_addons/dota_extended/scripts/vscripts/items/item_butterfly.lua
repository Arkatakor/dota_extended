...
item_extended_butterfly = class({})
LinkLuaModifier("modifier_item_extended_butterfly", "items/item_butterfly", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_extended_butterfly_unique", "items/item_butterfly", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_extended_butterfly_flutter", "items/item_butterfly", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_extended_butterfly_wind_song_stacks", "items/item_butterfly", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_extended_butterfly_wind_song_active", "items/item_butterfly", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_extended_butterfly_wind_song_slow", "items/item_butterfly", LUA_MODIFIER_MOTION_NONE)

function item_extended_butterfly:GetIntrinsicModifierName()
	return "modifier_item_extended_butterfly"
end

function item_extended_butterfly:OnSpellStart()
	-- Ability properties
	local caster = self:GetCaster()
	local ability = self	
	local sound_cast = "DOTA_Item.Butterfly"
	local modifier_flutter = "modifier_item_extended_butterfly_flutter"
...
modifier_item_extended_butterfly = class({})

function modifier_item_extended_butterfly:IsHidden() return true end
function modifier_item_extended_butterfly:IsPurgable() return false end
function modifier_item_extended_butterfly:IsDebuff() return false end
function modifier_item_extended_butterfly:GetAttributes() return MODIFIER_ATTRIBUTE_MULTIPLE end

function modifier_item_extended_butterfly:OnCreated()
	-- Ability properties
	self.caster = self:GetCaster()
	self.ability = self:GetAbility()
	self.modifier_unique = "modifier_item_extended_butterfly_unique"
	self.modifier_flutter = "modifier_item_extended_butterfly_flutter"
	self.modifier_active_song = "modifier_item_extended_butterfly_wind_song_active"
...
function modifier_item_extended_butterfly:DeclareFunctions()
...
function modifier_item_extended_butterfly:GetModifierBonusStats_Agility()
	return self.bonus_agility
end

function modifier_item_extended_butterfly:GetModifierPreAttack_BonusDamage()
	return self.bonus_damage
end

function modifier_item_extended_butterfly:GetModifierEvasion_Constant()
...
function modifier_item_extended_butterfly:GetModifierAttackSpeedBonus_Constant()
	return self.bonus_attack_speed
end

function modifier_item_extended_butterfly:OnDestroy()
	if IsServer() then
		-- Remove unique modifier if it is the last Butterfly in inventory
		if not self.caster:HasModifier("modifier_item_extended_butterfly") then
			self.caster:RemoveModifierByName("modifier_item_extended_butterfly_unique")
		end
	end
end
...
modifier_item_extended_butterfly_unique = class({})

function modifier_item_extended_butterfly_unique:OnCreated()
	-- Ability properties
	self.caster = self:GetCaster()
	self.ability = self:GetAbility()
	self.modifier_stacks = "modifier_item_extended_butterfly_wind_song_stacks"
	self.modifier_active_song = "modifier_item_extended_butterfly_wind_song_active"
...
function modifier_item_extended_butterfly_unique:IsHidden() return true end
function modifier_item_extended_butterfly_unique:IsPurgable() return false end
function modifier_item_extended_butterfly_unique:IsDebuff() return false end

function modifier_item_extended_butterfly_unique:DeclareFunctions()
	local decFuncs = {MODIFIER_EVENT_ON_ATTACK_FAIL}

	return decFuncs
end

function modifier_item_extended_butterfly_unique:OnAttackFail(keys)
...
function modifier_item_extended_butterfly_unique:OnDestroy()
	if IsServer() then
...
-- Flutter modifier
modifier_item_extended_butterfly_flutter = class({})

function modifier_item_extended_butterfly_flutter:OnCreated()
	-- Ability properties
	self.caster = self:GetCaster()
	self.ability = self:GetAbility()
...
function modifier_item_extended_butterfly_flutter:DeclareFunctions()
	local decFuncs = {MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}

	return decFuncs
end

function modifier_item_extended_butterfly_flutter:GetModifierMoveSpeedBonus_Percentage()
...
modifier_item_extended_butterfly_wind_song_stacks = class({})

function modifier_item_extended_butterfly_wind_song_stacks:OnCreated()
	-- Ability properties
	self.caster = self:GetCaster()
	self.ability = self:GetAbility()
	self.modifier_active_song = "modifier_item_extended_butterfly_wind_song_active"
...
function modifier_item_extended_butterfly_wind_song_stacks:IsHidden() return false end
function modifier_item_extended_butterfly_wind_song_stacks:IsPurgable() return true end
function modifier_item_extended_butterfly_wind_song_stacks:IsDebuff() return false end

function modifier_item_extended_butterfly_wind_song_stacks:OnStackCountChanged()
	if IsServer() then
...
modifier_item_extended_butterfly_wind_song_active = class({})

function modifier_item_extended_butterfly_wind_song_active:OnCreated()
	-- Ability properties
	self.caster = self:GetCaster()
	self.ability = self:GetAbility()
	self.particle_wind = "particles/item/butterfly/butterfly_wind_song.vpcf"
	self.modifier_slow = "modifier_item_extended_butterfly_wind_song_slow"
...
function modifier_item_extended_butterfly_wind_song_active:IsHidden() return false end
function modifier_item_extended_butterfly_wind_song_active:IsPurgable() return true end
function modifier_item_extended_butterfly_wind_song_active:IsDebuff() return false end

function modifier_item_extended_butterfly_wind_song_active:DeclareFunctions()
	local decFuncs = {MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE,
  				      MODIFIER_PROPERTY_ATTACKSPEED_BONUS_CONSTANT}
...
function modifier_item_extended_butterfly_wind_song_active:GetModifierMoveSpeedBonus_Percentage()
	return self.wind_song_bonus_ms_pct
end

function modifier_item_extended_butterfly_wind_song_active:GetModifierAttackSpeedBonus_Constant()
	return self.wind_song_bonus_as
end

function modifier_item_extended_butterfly_wind_song_active:OnIntervalThink()
	if IsServer() then
...
modifier_item_extended_butterfly_wind_song_slow = class({})

function modifier_item_extended_butterfly_wind_song_slow:OnCreated()
	-- Ability properties
	self.caster = self:GetCaster()
	self.ability = self:GetAbility()
...
function modifier_item_extended_butterfly_wind_song_slow:IsHidden() return false end
function modifier_item_extended_butterfly_wind_song_slow:IsPurgable() return true end
function modifier_item_extended_butterfly_wind_song_slow:IsDebuff() return true end

function modifier_item_extended_butterfly_wind_song_slow:DeclareFunctions()
	local decFuncs = {MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE}

	return decFuncs
end

function modifier_item_extended_butterfly_wind_song_slow:GetModifierMoveSpeedBonus_Percentage()
