...
function modifier_item_extended_curseblade:OnCreated()
	-- Ability properties
...
function modifier_item_extended_curseblade:IsHidden() return true end
function modifier_item_extended_curseblade:IsPurgable() return false end
function modifier_item_extended_curseblade:IsDebuff() return false end
function modifier_item_extended_curseblade:GetAttributes() return MODIFIER_ATTRIBUTE_MULTIPLE end
