...
function item_extended_skadi:GetIntrinsicModifierName()
	return "modifier_item_extended_skadi" 
end

-- Dynamic cast range
function item_extended_skadi:GetCastRange()
	local caster = self:GetCaster()	
	if caster and caster:HasModifier("modifier_item_extended_skadi") then
		return caster:GetModifierStackCount("modifier_item_extended_skadi", caster) 
	end
...
function modifier_item_extended_skadi:OnCreated(keys)
	if IsServer() then
		...
		if not self.parent:HasModifier("modifier_item_extended_skadi_unique") then
			self.parent:AddNewModifier(self.parent, self.ability, "modifier_item_extended_skadi_unique", {})
		end
...
function modifier_item_extended_skadi:OnDestroy()
	if IsServer() then		
		if not self.parent:HasModifier("modifier_item_extended_skadi") then
			self.parent:RemoveModifierByName("modifier_item_extended_skadi_unique")
		end
	end
end
...
function modifier_item_extended_skadi:UpdateCastRange()
	if IsServer() then						
