...
function modifier_extended_generic_talents_handler:OnCreated()
	if IsServer() then
...
function modifier_extended_generic_talents_handler:OnIntervalThink()
	if IsServer() then
...
function modifier_extended_generic_talents_handler:GetModifierConstantHealthRegen()
	if IsServer() then
...
function modifier_extended_generic_talents_handler:GetModifierPercentageCooldown()
	if IsServer() then
