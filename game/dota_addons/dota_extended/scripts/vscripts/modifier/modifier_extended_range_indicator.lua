...
modifier_extended_range_indicator = modifier_extended_range_indicator or class({})
function modifier_extended_range_indicator:IsDebuff() return false end
function modifier_extended_range_indicator:IsHidden() return true end
function modifier_extended_range_indicator:IsPurgable() return false end
function modifier_extended_range_indicator:IsPurgeException() return false end
function modifier_extended_range_indicator:IsStunDebuff() return false end
function modifier_extended_range_indicator:RemoveOnDeath() return self.bRemoveOnDeath end
-------------------------------------------

function modifier_extended_range_indicator:OnCreated( params )
	if IsServer() then
...
function modifier_extended_range_indicator:GetAttributes()
	return MODIFIER_ATTRIBUTE_MULTIPLE
end

function modifier_extended_range_indicator:OnDestroy()
	if IsServer() then
...
function modifier_extended_range_indicator:OnIntervalThink()
	if IsServer() then
